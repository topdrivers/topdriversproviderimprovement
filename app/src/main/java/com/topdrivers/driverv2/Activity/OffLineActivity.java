...
//                        }
    ...
    private void offLine() {
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public java.util.Map<String, String> getHeaders() {
                HashMap<String, String> headers = new HashMap<>();
                headers.put("X-Requested-With", "XMLHttpRequest");
                headers.put("Authorization", "Bearer " + SharedHelper.getKey(OffLineActivity.this, "access_token"));
                return headers;
            }
        };
        TopdriversApplication.getInstance().addToRequestQueue(jsonObjectRequest);
    ...
    public void GoToBeginActivity() {
        SharedHelper.putKey(OffLineActivity.this, "loggedIn", getString(R.string.False));
        Intent mainIntent = new Intent(OffLineActivity.this, WelcomeScreenActivity.class);
        mainIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
        startActivity(mainIntent);
        OffLineActivity.this.finish();
    }
