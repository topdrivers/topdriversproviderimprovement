...
import com.topdrivers.driverv2.Bean.Connect;
import com.topdrivers.driverv2.Fragment.EarningsFragment;
import com.topdrivers.driverv2.Fragment.Help;
import com.topdrivers.driverv2.Fragment.Map;
import com.topdrivers.driverv2.Fragment.SummaryFragment;
import com.topdrivers.driverv2.Helper.SharedHelper;
import com.topdrivers.driverv2.Helper.URLHelper;
import com.topdrivers.driverv2.Listeners.ConnectionBooleanChangedListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    public Activity contx = MainActivity.this;
    // flag to load home fragment when user presses back key
    private boolean shouldLoadHomeFragOnBackPress = true;
    private NotificationManager notificationManager;
    public static TopdriversApplication mMyApp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMyApp = (TopdriversApplication) this.getApplicationContext();
        ...
        try {
            Boolean ss = getIntent().getBooleanExtra("offline", false);
            String sf = SharedHelper.getKey(this, "offline");
...
//                .into(imgProfile);
    ...
    public void onBackPressed() {
        ...
        if (shouldLoadHomeFragOnBackPress) {
            ...
            // rather than home
            if (navItemIndex != 0) {
//                if (CURRENT_TAG.equalsIgnoreCase(TAG_SUMMARY) || CURRENT_TAG.equalsIgnoreCase
//                (TAG_EARNINGS)
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.POST,
            ...
            public void onResponse(JSONObject response) {
                ...
                if (!SharedHelper.getKey(MainActivity.this, "account_kit_token").equalsIgnoreCase("")) {
                    Log.e("MainActivity",
                            "Account kit logout: " + SharedHelper.getKey(MainActivity.this,
                                    "account_kit_token"));
                    AccountKit.logOut();
            ...
            public java.util.Map<String, String> getHeaders() throws AuthFailureError {
                ...
                Log.e("getHeaders: Token",
                        SharedHelper.getKey(context, "access_token") + SharedHelper.getKey(context, "token_type"));
...
//                .requestIdToken("795253286119-p5b084skjnl7sll3s24ha310iotin5k4.apps
//                .googleusercontent.com")
                    ...
                    Auth.GoogleSignInApi.signOut(mGoogleApiClient).setResultCallback(new ResultCallback<Status>() {
                        ...
                        public void onResult(@NonNull Status status) {
                            if (status.isSuccess()) {
                               ...
                               /* Intent intent = new Intent(LogoutActivity.this, LoginActivity
                               .class);
    ...
    public void playNotificationSound(Context context) {
        try {
            Uri notification = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://" + getApplicationContext().getPackageName() + "/" + R.raw.driver_logout);
