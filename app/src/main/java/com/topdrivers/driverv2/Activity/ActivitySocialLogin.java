...
//                        toastMessage = "Welcome to topdrivers...";
//                    } else {
//                        toastMessage = String.format(
//                                "Welcome to topdrivers...",
...
//        startActivityForResult(intent, APP_REQUEST_CODE);
        ...
        Intent mainIntent = new Intent(ActivitySocialLogin.this, ActivityPhone.class);
        mainIntent.putExtra("IS_LOGIN_SOCIAL", true);
